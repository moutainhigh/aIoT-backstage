...
public class WeXinUtils {
    ...
    public void warnPush(String first, String content, String occurtime, String remark) {
        //1，配置
...
//		String alarmPath = "http://192.168.10.17:9091/"+alarm.getFilePath()+ File.separator+alarm.getPdfName();
        ...
        templateMessage.setTemplateId(wxMpConfig.getWarn_template());
//				.url(alarmPath)//点击模版消息要访问的网址
        ...
        wxMpTemplateData.add(new WxMpTemplateData("content", content, "#FF0000"));
        wxMpTemplateData.add(new WxMpTemplateData("occurtime", occurtime, "#FF0000"));

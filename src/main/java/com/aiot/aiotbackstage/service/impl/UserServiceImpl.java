...
//    private SysSensorRecMapper sensorRecMapper;
    ...
    public void  batchSave () {
        ...
        cachedThreadPool.execute(new Task(this.parseDate("2020-02-01 00:00:00"), this.parseDate("2020-05-01 00:00:00")));
...
//                insectRecEntity.setResult(((int)(Math.random()*18)+1)+","+((int)(Math.random()*100))
//                        +"#"+((int)(Math.random()*18)+1)+","+((int)(Math.random()*100)));
//                Calendar cal = Calendar.getInstance();
//                cal.setTime(sdate);
//                cal.add(Calendar.HOUR, 1);
//                Date time = cal.getTime();
//                sdate=time;
//                insectRecEntity.setTime(sdate);
